...
require('lazy').setup({
  ...
  -- WARNING: First custom plugin added
  {
    'lervag/vimtex',
  ...
  -- for further information on this plugin please consult https://github.com/lervag/vimtex?tab=readme-ov-file#installation
  ...
  },
  {
    ...
    config = function()
      ...
      require('mason-tool-installer').setup { ensure_installed = ensure_installed } --, exclude = { 'stylua' } } used this once when fixing stylua
